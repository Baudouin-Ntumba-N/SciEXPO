...
urlpatterns = [
    ...
    path('articles/delete/<str:slug>', views.delete_article_view, name="delete-article"),
    ...
    path('articles/comment/replies/<int:comment_id>', views.comment_replies_view, name='comment-replies') ,
